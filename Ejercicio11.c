...
/*Notas de QA
QA: Kirbey garcia
Se realizaron 3 casos de prueba, eçlos cuales fueron ingresar un valor de retiro 
...
programa realizó correctamente las operaciones, o en su defecto devolvió el error
correspondiente.
