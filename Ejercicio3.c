...
el programa cumple con su función usando casos para determinar el día de la semana a partir del entero ingresado, cuenta con la estructura establecida. Sin embargo  uso de la variable confirmación sin utilidad.
*/
